...
export const PhoneOneDayClassBody = (props) => {
    ...
    return (<>
            ...
            <ContentWrapper>
                ...
                <div className="titlearea" data-value={props.openclass_id}>
                    ...
                    <div className="titlefooter">
                        {props.fordbobj == null ? <>--불러오는중--</> : props.fordbobj.onedayclass_name}
                    </div>
                    ...
                    */}
                    <div className="qnabtn" onClick={() => {
                        ...
                        if (cookiestatuscode!=1) {
                            ...
                            chatsocket.emit("chatapplication", { "id": userid, "onedayclass_num": onedayclass_num })
        ...
        {openmodal ? <>
            ...
            < ReservedModal device={"phone"} openmodal={openmodal} choiceforforDB={choiceforforDB} fordbobj={props.fordbobj}  ></ReservedModal >
        </> : <> null</>}
