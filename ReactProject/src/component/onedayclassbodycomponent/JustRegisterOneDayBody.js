...
export const JustRegisterOneDayBody = (props) => {
    ...
    useEffect(() => {
        ...
        for (let k = 0; k < test.length; k++) {
            ...
            test[k].addEventListener("click", (e) => {
                ...
                axios.get(`http://${IP}:4000/noneuser/ismagam?onedayclass_num=` + `${props.onedayclass_num}` + '&openningday=' + `${choiceforforDB}`)
                    .then((result) => {
                        ...
                        let { satstuscode, rest } = result.data
                        if (satstuscode == 1) {
                            alert("예약가능")
                            ...
                            restseat1[0].innerHTML = `<div>예약완료</div> <div>0자리 남음</div>`

                            document.getElementById("one").classList.add("restcss");
                        ...
                        if (rest == -1) {
                            ...
                            restseat1[0].innerHTML = `<div >${rest}</div> <div>자리 남음</div>`
                            document.getElementById("one").classList.add("restcss");
                        }
    ...
    console.log(props.fordbobj.Park)
    ...
    return (<>
            ...
            <ContentWrapper>
                                            ...
                                            props.이미지리스트.map((obj, index) => (
                                                ...
                                                <SwiperSlide Slide class="swiper-slide" >
                                                    {choiceclick.length == 0 ? <>
                                                        ...
                                                        choiceclick[0] != null ?
                                                            <>
                                                                <img style={{ width: "100%" }} src={`${props.이미지리스트[choiceclick[0]]}`}></img >
                                                            </>
                ...
                <div className="classdetailarea">
                    ...
                    <div className="park">
                        ...
                        <div>{props.fordbobj.Park == "준비중" ? <span>[채팅문의 주세요]</span> : props.fordbobj.Park}</div>

                    </div>
                    <div className="time">

                        <div style={{ height: "20px" }}><img style={{ height: "100%" }} src={`${time}`}></img></div>
                        <div>{props.fordbobj.PlayTime == "준비중" ? <span>[채팅문의 주세요]</span> : props.fordbobj.PlayTime}</div>
                    ...
                    <div className="headcount">
                        ...
                        <div>{props.fordbobj.Playinguser == "준비중" ? <span>[채팅문의 주세요]</span> : props.fordbobj.Playinguser}</div>
        ...
        {openmodal ? <>
            ...
            < ReservedModal device={"PC"} openmodal={openmodal} choiceforforDB={choiceforforDB} fordbobj={props.fordbobj}  ></ReservedModal >
        </> : <> null</>}
