...
export const TeaCherHeader = (props) => {
    ...
    if (teachersocket != undefined && teachersocket != null) {
        ...
        teachersocket.on(`chatsubmit${ window.localStorage.getItem("onedayclass_num")}`, (data) => {
                    ...
                    {tid == null ? <>
                        <Navul>
                            ...
                            <Navulli vmatch={props.vmatch} className='Navulli'>
                                <a onClick={() => { naviegate('/generallogin') }}>로그인</a>
                            </Navulli>
                                                        ...
                                                        return <div className="option" ><div>신청자: {e.id}</div>
                                                            <div className='confirm'>
                                                                <div onClick={() => {
                                                                    ...
                                                                    // 선생님 로그인은 백단의 설정과   pages/GeneralTeacherLogin.js  컴포에서
                                                                    //필요한걸 로컬스토리지에 저장해놨음
